<%@page import="mylibrary.web.enums.SearchType"%>
<%@page import="java.util.ArrayList"%>
<%@page import="mylibrary.web.beans.Book"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>

<%@include file="../WEB-INF/jspf/left_menu.jspf" %>

<jsp:useBean id="bookList" class="mylibrary.web.beans.BookList" scope="page"/>
...
<div class="book_list">
    ...
    %>
    <h5 style="text-align: left; margin-top:20px;">Found books: <%=list.size()%> </h5>
    ...
    <div class="book_info">
        ...
        <div class="book_details">
            ...
            <br><strong>Quantity of pages:</strong> <%=book.getPageCount()%>
            <br><strong>Year issue:</strong> <%=book.getPublishDate()%>
            <br><strong>Author</strong> <%=book.getAuthor()%>
            <p style="margin:10px;"> <a href="content.jsp?index=<%=list.indexOf(book)%>">Read</a></p>
        </div>
    </div>
